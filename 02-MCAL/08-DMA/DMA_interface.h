...
//DMA Flags
#define DMA_GIF   0  // (General Interrupt Flag)
#define DMA_TCIF  1 //  (Transfer Complete Interrupt Flag)
#define DMA_HTIF  2 // (Half Transfer Interrupt Flag)
#define DMA_TEIF  3 // (Transfer Error Interrupt Flag)
...
//DMA Configuration
//Direction
#define MEM_TO_MEM   0  // (Memory to Memory)
#define PREI_TO_MEM  1 //(Peripheral to Memory)
#define MEM_TO_PERI  2 //(Memory to Peripheral)
